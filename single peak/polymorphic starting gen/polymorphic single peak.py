...
for i1 in range(popn): #makingchanges to fitness of the individual on the basis of genome and epigenome
    gef[i1][2] = max(gfitnessref[ref_types.index(gef[i1][0])], efitnessref[ref_types.index(gef_transient[i1][1])]) 
...
plt.plot(generations, avg_w, 'r', generations[1000:], gm_forward, 'b', generations[:9000], gm_backward, 'y')
